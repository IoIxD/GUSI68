...
void GUSIContext::Setup(bool threading)
{
	...
	else if (!wasThreading && threading)
	{
		GUSIThreadManagerProxy::Instance()->SetThreadSwitcher(
			kApplicationThreadID, (ThreadSwitchProcPtr)GUSIContext::GUSIThreadSwitchIn, sCurrentContext, true);
		GUSIThreadManagerProxy::Instance()->SetThreadSwitcher(
			kApplicationThreadID, (ThreadSwitchProcPtr)GUSIContext::GUSIThreadSwitchOut, sCurrentContext, false);
...
void GUSIThreadSwitchOut(ThreadID, GUSIContext *context)
{
	context->SwitchOut();
}
